...
const { criarFormulario, gerarInput, validarFormulario } = await server.ssrLoadModule("/src/pages/Empresa/empresaFormulario.ts");
const { documentoEmpresaValido } = await server.ssrLoadModule("/src/utils/validators/documentoEmpresa.ts");
await server.close();
